...
module.exports = exports = async (database) => {

/*
	mongoose.connect('mongodb://localhost:27017/btss2018',{ useNewUrlParser: true});
	...
	async function createAuthors() {
		console.log('START WITH AUTHORS');
		...
		await console.log('DONE WITH AUTHORS');

	}

	async function createBooks() {
		console.log('START WITH BOOKS');
