...
const seedDatabase = (database) => {
	...
	return new Promise(async(resolve, reject) => {
		...
		// DROP COLLECTIONS ON RESTART OF THE APP
		Promise.all([
			...
			.then(() => console.log('Dropped old collections from previous session.'))
			.catch(e => console.log('Failed to drop collections from previous session. ', e));
